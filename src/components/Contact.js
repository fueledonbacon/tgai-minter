        ...
        <div className="fn_cs_contact_info">
          <ul>
            <li>
              <div className="item">
                <p>
                  For more information about the project, the mint or the team,
                  please complete the form below and one of our representatives
                  will respond in a timely fashion. Thank you for your interest
                  in TGAI.
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="item">
                ...
                <h3>
                  <a href="mailto:info@tgai.xyz">info@tgai.xyz</a>
                </h3>
              </div>
            </li>
          </ul>
