        ...
        <div className="right_part">
          <div className="right_in">
            <h3
              ...
              data-text="About Trans-Galactic Adoption Intermediaries"
            >
              About Trans-Galactic Adoption Intermediaries
            </h3>
            ...
            <div className="desc">
              <p>
                Collectibles were fun when we were growing up. My wife and I
                both collected Garbage Pail Kids and our kids collected Yu-Gi-Oh
                and Pokemon. When they saw some of the AI work I was doing, they
                wanted to turn my aliens into collectibles and have them adopted
                like my kids were. Thus, TGAI was born.
              </p>
              <p>
                As a family, we built TGAI to make PFP collectibles fun again
                with great artwork and a fun topic. However, as we all know with
                collectibles, they need to grow in value. We worked rarity
                traits and categories into the design and curation specifically
                for that reason. Each has a Rank Index number (the lower the
                better) and each has where its rarity falls into the collection
                on the image itself.
              </p>
              <p>
                TGAI is a 0% secondary royalty collection and all come with IP
                ownership (images available without ranking watermark). All
                images are 2048 by 2048. Minting starts at 6:00 PM CST on
                February 12th, 2023.
              </p>
            </div>
            <a
