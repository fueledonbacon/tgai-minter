    ...
    <section id="home">
      <div className="container">
        <h3
          ...
          data-text="Trans-Galactic Adoption Intermediaries"
          data-align="center"
        >
          Trans-Galactic Adoption Intermediaries
        </h3>
        {/* Slider */}
        ...
        <div className="fn_cs_desc">
          <p>
            Trans-Galactic Adoption Intermediaries is a collection of AI
            assisted aliens that have been allocated to Earth to be adopted.
            They come from all across the galaxies just to be collected by the
            wonderful people of web3. All are individually ranked by category
        ...
        <MintBox/>
          <a
            ...
            rel="noreferrer"
          >
            <span>Buy Secondary on OpenSea</span>
          </a>
        </div>
        {/* !Description */}
      </div>
